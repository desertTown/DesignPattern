...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("id: "+ javaDiscountCourse.getId() + " 课程名称：" + javaDiscountCourse.getName() + " 课程打折后的价格："+ javaDiscountCourse.getPrice()+ " 课程原价：" + javaDiscountCourse.getOriginPrice());
    }
}
